...
public class UrlHelper {
    ...
    private final static String URL_BING_IMAGE_GUOLIN = "http://guolin.tech/api/bing_pic";
    ...
    public static String generateBingImageGuoLinUrl(){
        return URL_BING_IMAGE_GUOLIN;
    }
